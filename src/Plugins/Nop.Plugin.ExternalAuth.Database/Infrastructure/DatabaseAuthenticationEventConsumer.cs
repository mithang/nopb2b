...
namespace Nop.Plugin.ExternalAuth.Database.Infrastructure
{
    ...
    /// </summary>
    public partial class DatabaseAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public DatabaseAuthenticationEventConsumer(IGenericAttributeService genericAttributeService)
        {
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(DatabaseAuthenticationDefaults.SystemName))
                return;
