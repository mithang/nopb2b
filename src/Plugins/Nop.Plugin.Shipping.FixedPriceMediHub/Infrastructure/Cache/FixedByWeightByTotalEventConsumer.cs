...
namespace Nop.Plugin.Shipping.FixedPriceMediHub.Infrastructure.Cache
{
    /// <summary>
    ...
    public partial class FixedByWeightByTotalEventConsumer : IConsumer<EntityDeletedEvent<ShippingMethod>>
    {
        ...
        public void HandleEvent(EntityDeletedEvent<ShippingMethod> eventMessage)
        {
            ...
            var setting = _settingService.GetSetting(string.Format(FixedPriceMediHubDefaults.FixedRateSettingsKey, shippingMethod.Id));
            if (setting != null)
