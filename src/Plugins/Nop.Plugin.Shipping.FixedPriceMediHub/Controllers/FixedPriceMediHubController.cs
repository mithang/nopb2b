...
using Nop.Plugin.Shipping.FixedPriceMediHub.Domain;
using Nop.Plugin.Shipping.FixedPriceMediHub.Models;
...
namespace Nop.Plugin.Shipping.FixedPriceMediHub.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    public class FixedPriceMediHubController : BasePluginController
    {
        #region Fields
        ...
        public FixedPriceMediHubController(CurrencySettings currencySettings,
            FixedPriceMediHubSettings fixedByWeightByTotalSettings,
        ...
        public IActionResult Configure()
        {
            ...
            return View("~/Plugins/Shipping.FixedPriceMediHub/Views/Configure.cshtml", model);
        }
        ...
        public IActionResult UpdateFixedShippingRate(FixedRateModel model)
        {
            ...
            _settingService.SetSetting(string.Format(FixedPriceMediHubDefaults.FixedRateSettingsKey, model.ShippingMethodId), model.Rate);
            ...
            var gridModel = new ShippingByWeightByTotalListModel().PrepareToGrid(searchModel, records, () =>
            {
                return records.Select(record =>
                {
                    ...
                    htmlSb.AppendFormat("{0}: {1}",
                        _localizationService.GetResource("Plugins.Shipping.FixedPriceMediHub.Fields.WeightFrom"),
                        model.WeightFrom);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}",
                        _localizationService.GetResource("Plugins.Shipping.FixedPriceMediHub.Fields.WeightTo"),
                        model.WeightTo);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}",
                        _localizationService.GetResource(
                            "Plugins.Shipping.FixedPriceMediHub.Fields.OrderSubtotalFrom"), model.OrderSubtotalFrom);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}",
                        _localizationService.GetResource(
                            "Plugins.Shipping.FixedPriceMediHub.Fields.OrderSubtotalTo"), model.OrderSubtotalTo);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}",
                        _localizationService.GetResource(
                            "Plugins.Shipping.FixedPriceMediHub.Fields.AdditionalFixedCost"),
                        model.AdditionalFixedCost);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}",
                        _localizationService.GetResource(
                            "Plugins.Shipping.FixedPriceMediHub.Fields.RatePerWeightUnit"), model.RatePerWeightUnit);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}",
                        _localizationService.GetResource(
                            "Plugins.Shipping.FixedPriceMediHub.Fields.LowerWeightLimit"), model.LowerWeightLimit);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}",
                        _localizationService.GetResource(
                            "Plugins.Shipping.FixedPriceMediHub.Fields.PercentageRateOfSubtotal"),
        ...
        public IActionResult AddRateByWeightByTotalPopup()
        {
            ...
            return View("~/Plugins/Shipping.FixedPriceMediHub/Views/AddRateByWeightByTotalPopup.cshtml", model);
        }
        ...
        public IActionResult EditRateByWeightByTotalPopup(int id)
        {
            ...
            return View("~/Plugins/Shipping.FixedPriceMediHub/Views/EditRateByWeightByTotalPopup.cshtml", model);
        }
