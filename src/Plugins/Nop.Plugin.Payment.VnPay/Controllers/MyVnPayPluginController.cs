...
namespace Nop.Plugin.Payment.VnPay.Controllers
{
    [Area(AreaNames.Admin)]
    public class MyVnPayPluginController : BasePluginController
    {
        ...
        public MyVnPayPluginController(ILocalizationService localizationService,
        ...
        public IActionResult Configure()
        {
            ...
            return View("~/Plugins/Payment.VnPay/Views/Configure.cshtml", model);
        }
